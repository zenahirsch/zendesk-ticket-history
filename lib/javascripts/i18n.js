...
const I18n = Object.freeze({
  t: function(key, context) {
    ...
    if (typeof template !== 'function') {
      throw new Error(`Invalid precompiled translation for key: ${key}`);
    }
...
Handlebars.registerHelper('t', function(key, context) {
  try {
    return new Handlebars.SafeString(I18n.t(key, context.hash));
  } catch(e) {
    console.error(e);
    return new Handlebars.SafeString(Handlebars.escapeExpression(e.message));
  }
});
